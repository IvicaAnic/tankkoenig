...
import {Course, sortCoursesBySeqNo, Tank} from "../models/course.model";
...
export class HomeComponent {
  ...
  async loadCourses() {
    try {
      ...
      //const courses1 = await this.coursesService.loadAllTank();
     // this.#coursestank.set(courses1);
     // console.log("all course " + courses1)
